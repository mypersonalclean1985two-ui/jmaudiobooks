    ...
    if (activeTab === 'chapters') {
        chapters.forEach((chapter, index) => {
            ...
            div.innerHTML = `
                ...
                <ion-icon name="play-circle-outline" style="font-size: 1.5rem; opacity: 0.5;"></ion-icon>
            `;
            div.onclick = () => {
                if (chapter.fileUrl) {
        ...
        if (bookmarks.length === 0) {
            container.innerHTML = '<div style="text-align:center; padding:20px; color:var(--text-secondary);">No bookmarks yet</div>';
            return;
        }
